...
export interface TrustlessMulticallInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getBlockHash" | "getBlockNumber" | "getChainId" | "getCurrentBlockCoinbase" | "getCurrentBlockDifficulty" | "getCurrentBlockGasLimit" | "getCurrentBlockTimestamp" | "getEthBalance" | "getLastBlockHash" | "multicallNoRevertOnError" | "multicallRevertOnError"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "multicallRevertOnError", values: [TrustlessMulticall.WriteCallStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "multicallRevertOnError", data: BytesLike): Result;
    events: {};
}
export interface TrustlessMulticall extends BaseContract {
    ...
    functions: {
        ...
        multicallRevertOnError(calls: TrustlessMulticall.WriteCallStruct[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    getBlockHash(blockNumber: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        multicallRevertOnError(calls: TrustlessMulticall.WriteCallStruct[], overrides?: CallOverrides): Promise<string[]>;
    };
    filters: {};
    estimateGas: {
